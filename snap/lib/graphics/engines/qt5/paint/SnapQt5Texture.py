...
def build(ENV):
	...
	class SnapQt5Texture(SnapTexture):
		...
		class __engine_data__:
			...
			def get(self, MSG):
				...
				if image is not None:
					qimage = image['__engine_data__'] # use the QImage
					if qimage is not None:
						return qimage
				#return Qt5.QColor(0,0,0) # ?
				return Qt5.QPixmap(1,1)
	...
	ENGINE.SnapQt5Texture = SnapQt5Texture
	return SnapQt5Texture
