...
def build(ENV):
	...
	ENV.__build__('snap.lib.graphics.event.SnapEvent')
	#ENV.__build__('snap.lib.graphics.interaction.SnapInteractCombo')

	ENV.__build__('snap.lib.graphics.event.SnapEventManager')
