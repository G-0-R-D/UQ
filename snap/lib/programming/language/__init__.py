...
def build(ENV):
	...
	ENV.__build__('snap.lib.programming.language.SnapProgrammingLanguage')
	ENV.__build__('snap.lib.programming.language.SnapProgrammingLanguageCompiler')
	ENV.__build__('snap.lib.programming.language.SnapProgrammingLanguageDecoder')
	#ENV.__build__('snap.lib.programming.language.SnapProgrammingLanguageProject')
	...
	for name in os.listdir(THISDIR):
		...
		try:
			LANGUAGES[name] = ENV.__build__('snap.lib.programming.language.' + name)
