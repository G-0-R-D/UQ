...
def build(ENV):
	...
	class SnapText(SnapShape):
		...
		@text_extents.alias
		class ink_extents: pass # subclass can separate if it makes sense to do so...
...
####### Metrics
		...
		@ENV.SnapChannel
		def glyph_at_position(self, MSG):
			raise NotImplementedError()

		@ENV.SnapChannel
		def line_at_position(self, MSG):
			raise NotImplementedError()

		@ENV.SnapChannel
		def subline_at_position(self, MSG):
