...
def build(ENV):
	...
	ENV.__build__('snap.os.devices.snap_device_util')

	ENV.__build__('snap.os.devices.SnapDeviceNode')
	ENV.__build__('snap.os.devices.SnapDeviceInput')
	ENV.__build__('snap.os.devices.SnapDeviceGroup')
